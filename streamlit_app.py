...
# --- دالة قراءة اللوجو برابط مباشر لضمان الظهور ---
@st.cache_data
...
if df_f is not None:
    ...
    # الربط الصحيح للـ Total Inbound بالتاريخ
    ...
    with tabs[0]: # Overview
        ...
        # السطر اللي كان مسبب الأزمة: دلوقت بيقرأ من الشهور المفلترة (fs)
        inb_val = int(to_n(fs['Offered']).sum())
