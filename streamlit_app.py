...
# ✅ CSS - تطوير تنسيق الكروت وزر اللوج أوت
st.markdown(f"""
    <style>
    ...
    /* 📱 تنسيق كروت الواتساب المطور */
    .wa-card {{ 
        background-color: white !important; 
        padding: 15px !important; 
        border-radius: 10px !important; 
        border: 1px solid #f0f2f6 !important;
        border-top: 5px solid {DS_BLUE} !important; 
        box-shadow: 0 10px 20px rgba(0,0,0,0.1) !important; /* بروز أقوى */
        text-align: center;
        margin-bottom: 15px;
    }}
    .wa-card h5 {{ margin-bottom: 5px; color: #555; font-size: 16px; }}
    .wa-card h2 {{ margin: 0; color: {DS_BLUE}; font-size: 24px; }}
    .wa-card p {{ font-size: 13px; margin-top: 5px; }}
...
# ✅ زر الـ Log Out في الـ Sidebar بعد الدخول
st.sidebar.button("🔓 Log Out / Lock Access", on_click=logout)
