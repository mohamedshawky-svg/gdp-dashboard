...
# --- محتوى الداشبورد ---
if df_f is not None:
    # تعديل إظهار اللوجو والاسم جوه الداشبورد من فوق
    if icon_inner_64:
        st.markdown(f"""
    ...
    # تصحيح الـ Total Inbound: الربط بفلتر التاريخ
    ...
    with tabs[0]:
        ...
        # الرقم دلوقت هيتغير لما تغير التاريخ
